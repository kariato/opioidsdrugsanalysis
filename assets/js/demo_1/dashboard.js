(function ($) {
  ...
  $(function () {
    ...
    if ($('#total-revenue').length) {
      ...
      if ($('#total-revenue3').length) {
          var ctx = document.getElementById('total-revenue3').getContext("2d");
          var data = {
              labels: [
                  "Day01",
                  "Day02",
      ...
      if ($('#total-revenue2').length) {
          var ctx = document.getElementById('total-revenue2').getContext("2d");
          var data = {
              labels: [
                  "Day01",
                  "Day02",
    ...
    if ($('#total-transaction').length) {
      ...
      if ($('#total-transaction2').length) {
          var ctx = document.getElementById('total-transaction2').getContext('2d');
          var gradientStrokeFill_1 = ctx.createLinearGradient(0, 100, 200, 0);
          gradientStrokeFill_1.addColorStop(0, '#fa5539');
          gradientStrokeFill_1.addColorStop(1, '#fa3252');
          var areaData = {
